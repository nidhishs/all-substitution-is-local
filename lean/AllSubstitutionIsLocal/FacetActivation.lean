...
(geometric). This makes the active learning interpretation of the main theorems a
proved consequence rather than an interpretive claim.
...
/-- **Facet-Activation Bridge**: VoI > 0 ↔ some posterior prefers a rival action over `aStar`.
    Makes the active learning interpretation a proved consequence. -/
