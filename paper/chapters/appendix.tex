...
The primary experiment uses the in-domain checkpoint \texttt{densenet121-res224-chex}; the robustness analyses below use all six publicly available checkpoints.
