...
\]
The geometric takeaway is simple: predictive gain without a reachable boundary crossing has zero decision value for the deployed action set.
We formalize in Lean~4 both the zero-regret boundary condition and the value-of-information identity above.
The rest of the paper develops this criterion in four steps:
\begin{itemize}[nosep,leftmargin=1.5em]
  ...
  \item We show that ex ante $\BRhat$ improves scarce-review allocation over reward-aware margin, reward-agnostic uncertainty, residual-expertise, and learning-to-defer baselines where boundary-regret mass is reachable, and converges to reward-aware margin where it is not --- both outcomes predicted by Theorem~\ref{thm:facet-bridge}.
\end{itemize}
