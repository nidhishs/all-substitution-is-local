...
The same logic applies to sensor placement and attention allocation under capacity constraints: diversifying across decision boundaries is more valuable than concentrating on a single one.
